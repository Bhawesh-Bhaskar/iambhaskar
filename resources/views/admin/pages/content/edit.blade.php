            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.content.index') }}">Pages List</a>
                        </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.content.update', $pageData->slug) }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
                                    @csrf()
                                
                                    <div class="form-body">
                                        <h4 class="form-section"><i class="fa fa-eye"></i> Edit Page</h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput1">Name : <span class="danger">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1" class="form-control border-primary" placeholder="Name" name="name" value="{{ $pageData->name }}" required="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">      
                                                        <textarea class="summernote" name="content">{{ $pageData->content }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

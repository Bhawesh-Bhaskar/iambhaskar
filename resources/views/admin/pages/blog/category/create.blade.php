				...
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Add Blog Category
							</li>
						</ol>
					</div>
				</div>
				        ...
				        <div class="card">
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ route('admin.blogcategory.store') }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
										@csrf()
										<div class="form-body">
											<h4 class="form-section"><i class="fa fa-eye"></i> Add Blog Category</h4>
											<div class="row">
												<div class="col-md-12">

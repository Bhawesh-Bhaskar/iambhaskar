                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.blog.update', $blogData->slug) }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
                                @csrf()
                              
                                <div class="form-body">
                                    <h4 class="form-section"><i class="fa fa-eye"></i> Edit Blog</h4>
                                    <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                        <label class="col-md-3 label-control" for="userinput1">Title : <span class="danger">*</span></label>
                                        <div class="col-md-9">
                                            <input type="text" id="userinput1" class="form-control border-primary" placeholder="Title" name="title" value="{{ $blogData->title }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="userinput1" class="form-control border-primary" placeholder="Short Description" name="short_description" value="{{ $blogData->short_description }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">      
                                                    <textarea class="summernote" name="description">{{ $blogData->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-9">
                                                <select name="category" class="form-control select2"> 
                                                        ...
                                                        @foreach($blog_categories as $s)
                                                            <option value="{{ $s->id }}" <?php if($s->id == $blogData->category){ echo "selected"; } ?>>{{ $s->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="tag" class="form-control select2"> 
                                                        <option>--Select--</option>
                                                        @foreach($blog_tags as $s)
                                                            <option value="{{ $s->id }}" <?php if($s->id == $blogData->tag){ echo "selected"; } ?>>{{ $s->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                @if(trim($blogData->image))
                                                    <img src="{{ asset('assets/img/blogs/'.$blogData->image) }}" id="imagePreview" style="width: 100%; height: 300px;">
                                                @else
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="userinput1" class="form-control border-primary" placeholder="Credit" name="credit" value="{{ $blogData->credit }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="userinput1" class="form-control border-primary" placeholder="Credit URL" name="credit_url" value="{{ $blogData->credit_url }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="userinput1" class="form-control border-primary" placeholder="Order" value="{{ $blogData->orderby }}" name="orderby">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                            	...
                                            	<div class="col-md-9">
                                                	<select class="form-control select2" name="status">
                                                	    <option value="1" @if($blogData->status == '1') selected @endif>Active</option>
                                                	    <option value="0" @if($blogData->status == '0') selected @endif>Inactive</option>
                                                	</select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" id="userinput1" name="featured" @if($blogData->featured == '1') checked @endif>
                                            </div>
                                        </div>
                                    </div>
                                    </div>

                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Social Media
                            </li>
                        </ol>
                    </div>
                </div>
				        ...
				        <div class="card">
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ route('admin.social.update', $socialData->slug) }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
										@csrf()
                                        <div class="form-body">
                                        	<h4 class="form-section"><i class="fa fa-eye"></i>Edit Social Media</h4>
                                        	<div class="row">
                                        		<div class="col-md-12">
                                                    <div class="form-group row">
                                                    	<label class="col-md-3 label-control" for="name">Name : <span class="danger">*</span></label>
                                                    	<div class="col-md-9">
                                                        	<input type="text" id="name" class="form-control border-primary" placeholder="Name" name="name" value="{{ $socialData->name }}" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                        		<div class="col-md-12">
                                                    <div class="form-group row">
                                                    	...
                                                    	<div class="col-md-9">
                                                        	<input type="text" id="link" class="form-control border-primary" placeholder="Link" name="link" value="{{ $socialData->link }}" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="icon-input" class="form-control border-primary" placeholder="Icon (e.g., fa-camera)" name="icon"  value="{{ $socialData->icon }}" required="">
                                                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            @if(trim($socialData->image))
                                                                <img src="{{ asset('assets/img/socials/'.$socialData->image) }}" id="imagePreview" class="organisation-logo">
                                                            @else
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="form-control select2" name="status">
                                                                <option value="1" @if($socialData->status == '1') selected @endif>Active</option>
                                                                <option value="0" @if($socialData->status == '0') selected @endif>Inactive</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                        		<div class="col-md-12">
                                                    <div class="form-group row">
                                                    	...
                                                    	<div class="col-md-9">
                                                        	<input type="number" id="userinput1" class="form-control border-primary" placeholder="Order" name="orderby" value="{{ $socialData->orderby }}" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

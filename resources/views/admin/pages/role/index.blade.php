        ...
        <div class="content-header row">
			...
			<div class="col-md-4 text-right">
				<a href="{{ route('admin.roles.create') }}">
					<button class="btn btn-primary"><i class="fa fa-plus"></i> Add Role</button>
                </a>
			</div>
        </div>
										...
										@if(count($roles) > 0)
											@foreach($roles as $k=>$u)
												<tr>
													...
													<td>
													    <a href="{{ route('admin.roles.edit', $u->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
															<button type="button" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
														</a>&nbsp;	
														@if($u->id != '1')								
															<button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ route('admin.roles.delete', $u->id) }}')" data-toggle="tooltip" data-placement="top" title="Delete">

				        ...
				        <div class="card">
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ route('admin.users.update', $userData->id) }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
										@csrf()
				                    	<div class="form-body">
				                    		<h4 class="form-section"><i class="fa fa-eye"></i> Edit User</h4>
				                    		<div class="row">
				                    			<div class="col-md-6">
							                        <div class="form-group row">
							                        	<label class="col-md-3 label-control" for="name">Name</label>
							                        	<div class="col-md-9">
							                            	<input type="text" id="name" class="form-control border-primary" placeholder="Name" name="name" value="{{ $userData->name }}" required="">
							                            </div>
							                        </div>
							                    </div>
					                        	<div class="col-md-6">
					                        		<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
															<input class="form-control border-primary" type="email" placeholder="Email" id="email" value="{{ $userData->email }}" readonly>
							                        	</div>
								                    </div>
					                        	</div>
						                       	<div class="col-md-6">	
													<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
															<input class="form-control border-primary" type="tel" placeholder="Phone Number" id="phone" name="phone" value="{{ $userData->phone }}" required="">
														</div>
							                        </div>
						                       	</div>
                                                <div class="col-md-6">
												    <div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
															<select class="form-control border-primary" name="status" id="status" required="">
																<option value="1" @if($userData->status == '1') selected @endif>Active</option>
																<option value="0" @if($userData->status == '0') selected @endif>Inactive</option>
															</select>
														</div>
							                        </div>
												</div>
												<div class="col-md-6">
                                                    <div class="form-group row">
                                                    	...
                                                    	<div class="col-md-9">
                                                            ...
                                                            @if($userData->image)
                                                                <img src="{{ asset('assets/img/users/'.$userData->image)}}" id="imagePreview" class="organisation-logo" alt="Your image will appear here.">
                                                            @else

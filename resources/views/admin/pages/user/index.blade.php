										...
										@if(count($users) > 0)
											@foreach($users as $k=>$u)
												<tr>
													...
													<td>
													    <a href="{{ route('admin.users.edit', $u->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
															<button type="button" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
														</a>&nbsp;							
														<button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ route('admin.users.delete', $u->id) }}')" data-toggle="tooltip" data-placement="top" title="Delete">

				        ...
				        <div class="card">
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ route('admin.ticket.store') }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
										@csrf()
                                        <div class="form-body">
                                        	<h4 class="form-section"><i class="fa fa-eye"></i>Add Ticket</h4>
                                        	<div class="row">
                                        		<div class="col-md-12">
											...
											<div class="row">
                                        		<div class="col-md-12">
                                                    <div class="form-group row">
                                                    	<label class="col-md-3 label-control" for="assignee">Assignee : <span class="danger">*</span></label>
                                                    	<div class="col-md-9">
											...
											<div class="row">
                                        		<div class="col-md-12">
                                                    <div class="form-group row">
                                                    	<label class="col-md-3 label-control" for="user">User : <span class="danger">*</span></label>
                                                    	<div class="col-md-9">

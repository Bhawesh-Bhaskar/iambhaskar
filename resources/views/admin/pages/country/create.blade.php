                        ...
                        <div class="card">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.country.store') }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
                                        @csrf()
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="fa fa-eye"></i> Add Country</h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="short_name" class="form-control border-primary" placeholder="Short Name" name="short_name" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="iso3" class="form-control border-primary" placeholder="ISO3" name="iso3" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="number_code" class="form-control border-primary" placeholder="Number Code" name="number_code" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="phone_code" class="form-control border-primary" placeholder="Phone Code" name="phone_code" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="currency_code" class="form-control border-primary" placeholder="Currency Code" name="currency_code" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
